...
it is also missing a uniform set of operations applicable across such `Collections`. leading to ongoing developer dissatisfaction.
...
### The SequencedCollection Interface to the rescu